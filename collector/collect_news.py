...
RECENT_DAYS = 7         # RSS·gnews 기사 최근 N일
...
선별 규칙:
1. 관련 없는 항목, 단순 홍보·행사·채용·시스템점검 공지는 제외. 단, 관청 공식 발표는 행정공지가 아닌 한 관련성을 폭넓게 인정하세요. 일본어·중국어 후보는 제목만으로 판단하되 언어를 이유로 제외하지 마세요. '(유료)' 표시 출처는 제목 정보만으로 판단하세요.
