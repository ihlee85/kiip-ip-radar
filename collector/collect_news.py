...
4. 기본 상한 {cap}건, 정책적 중요도가 높은 순. 특히 제도변화 기사(규칙·법령·심사기준의 제정·개정·입법예고·의견수렴·확정·시행)는 이 아카이브의 핵심 목적이므로 중요도 판단에서 최우선으로 다루세요.
...
{{"idx": 후보번호,
  "topic": {topics} 중 하나 (핵심 주제 1개). 특히 '심사·제도'는 심사기준·규칙(rule)의 제·개정, 법령 개정안·입법예고·의견수렴·확정·시행, 수수료·절차 개편 등 지식재산 제도의 '변화'에 관한 기사를 폭넓게 포괄합니다. 제도변화 기사는 반드시 '심사·제도'로 분류하세요.
